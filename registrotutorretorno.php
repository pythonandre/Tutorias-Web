<?php
    ...
    if(isset($_POST["submit"])) {
        ...
        $emailCheck = $connection->query( "SELECT * FROM TUTOR WHERE tutor_email = '{$email}' ");
        ...
        if(!empty($name) && !empty($email) && !empty($password) && !empty($password2) && !empty($certificado) && $password == $password2){
            ...
            $sql = $connection->query("INSERT INTO tutor (tutor_nombre, tutor_email, tutor_password, tutor_grado, tutor_certificado) 
