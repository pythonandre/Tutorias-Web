<?php include('paneladminretorno.php'); ?>
...
<br>
  ...
  <li class="nav-item">
    <a class="nav-link active" aria-current="page" href="paneladmin.php">Perfil</a>
    <br>
  ...
  <li class="nav-item">
    <a class="nav-link" href="peticioncurso.php">Peticiones de Cursos</a>
  </li>
  </ul>
  <br>
