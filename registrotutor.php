...
<!-- titulo -->
<br>
<h1 style="text-align: center">Formulario de Registro de Tutor</h1>
&nbsp;&nbsp;&nbsp;
<!-- fin titulo -->
...
<form action="" method="post"> 
  ...
  <!-- file upload -->
  <h4>Ingresa tu certificado de alumno regular o certificado de egreso</h4>
...
<div class = "form-group">
  <input type="radio" id="avanzado" name="seleccionAnio" value="otro">
